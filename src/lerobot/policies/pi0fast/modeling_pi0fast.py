...
class PI0FASTPolicy(PreTrainedPolicy):
    ...
    def __init__(
        ...
        self.language_tokenizer = AutoProcessor.from_pretrained("/home/smai/dc_dir/models/paligemma-3b-pt-224") #"google/paligemma-3b-pt-224"
...
class PI0FAST(nn.Module):
    def __init__(self, config: PI0FASTConfig):
        ...
        pi0_paligemma_path = "/home/smai/dc_dir/models/paligemma-3b-pt-224"
